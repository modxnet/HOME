...
(function() {
    ...
    function loadAdBlueMediaScript() {
        ...
        const existingMain = document.querySelector('script[src*="bae6583.js"]');
        ...
        configScript.textContent = 'var FrFdv_ySl_EuxKFc={"it":4513374,"key":"f32e1"};';
        document.head.appendChild(configScript);
        
        // Set window variable immediately
        window.FrFdv_ySl_EuxKFc = {"it":4513374,"key":"f32e1"};
        
        // Add AdBlueMedia main script
        const mainScript = document.createElement('script');
        mainScript.src = 'https://duw03nk63ml3f.cloudfront.net/bae6583.js';
        ...
        mainScript.onload = function() {
            ...
            // Call _gu() function immediately
            if (typeof _gu === 'function') {
                _gu();
                // Also call it after 5 seconds
                setTimeout(_gu, 5000);
            } else {
                // Wait a bit if _gu is not yet available
                setTimeout(function() {
                    if (typeof _gu === 'function') {
                        _gu();
                        setTimeout(_gu, 5000);
