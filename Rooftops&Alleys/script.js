...
(function() {
    ...
    function loadAdBlueMediaScript() {
        ...
        const existingMain = document.querySelector('script[src*="bc1cd52.js"]');
        ...
        configScript.textContent = 'var tXcFy_cwU_DDjdac={"it":4520979,"key":"50380"};';
        document.head.appendChild(configScript);
        
        // Set window variable immediately
        window.tXcFy_cwU_DDjdac = {"it":4520979,"key":"50380"};
        
        // Add AdBlueMedia main script
        const mainScript = document.createElement('script');
        mainScript.src = 'https://duw03nk63ml3f.cloudfront.net/bc1cd52.js';
        ...
        mainScript.onload = function() {
            ...
            // Call _ou() function immediately
            if (typeof _ou === 'function') {
                _ou();
                // Also call it after 5 seconds
                setTimeout(_ou, 5000);
            } else {
                // Wait a bit if _ou is not yet available
                setTimeout(function() {
                    if (typeof _ou === 'function') {
                        _ou();
                        setTimeout(_ou, 5000);
